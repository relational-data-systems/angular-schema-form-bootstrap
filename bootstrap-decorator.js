...
$templateCache.put("decorators/bootstrap/radio-buttons.html","<div class=\"form-group schema-form-radiobuttons {{::form.htmlClass}}\" ng-class=\"{\'has-error\': form.disableErrorState !== true && hasError(), \'has-success\': form.disableSuccessState !== true && hasSuccess(), \'required\': form.required}\"><div><label class=\"control-label {{::form.labelHtmlClass}}\" ng-show=\"showTitle()\">{{::form.title}} <a ng-if=\"form.tooltip\" data-toggle=\"tooltip\" data-placement=\"right\" title=\"{{::form.tooltip}}\"><i class=\"glyphicon glyphicon-info-sign\"></i></a></label></div><div class=\"btn-group\"><label sf-field-model=\"replaceAll\" class=\"btn {{ (item.value === $$value$$) ? form.style.selected || \'btn-default\' : form.style.unselected || \'btn-default\'; }}\" ng-class=\"{ active: item.value === $$value$$ }\" ng-repeat=\"item in form.titleMap\"><input type=\"radio\" class=\"{{::form.fieldHtmlClass}} hidden\" sf-changed=\"form\" ng-disabled=\"form.readonly\" sf-field-model=\"\" schema-validate=\"form\" ng-value=\"item.value\" name=\"{{::form.key.join(\'.\')}}\"> <span ng-bind-html=\"item.name\"></span></label></div><div class=\"help-block\" sf-message=\"form.description\"></div></div>");
$templateCache.put("decorators/bootstrap/radios-inline.html","<div class=\"form-group schema-form-radios-inline {{::form.htmlClass}}\" ng-class=\"{\'has-error\': form.disableErrorState !== true && hasError(), \'has-success\': form.disableSuccessState !== true && hasSuccess(), \'required\': form.required}\"><label class=\"control-label {{::form.labelHtmlClass}}\" ng-show=\"showTitle()\" sf-field-model=\"\" schema-validate=\"form\">{{::form.title}} <a ng-if=\"form.tooltip\" data-toggle=\"tooltip\" data-placement=\"right\" title=\"{{::form.tooltip}}\"><i class=\"glyphicon glyphicon-info-sign\"></i></a></label><div><label class=\"radio-inline\" ng-repeat=\"item in form.titleMap\"><input type=\"radio\" class=\"{{::form.fieldHtmlClass}}\" sf-changed=\"form\" ng-disabled=\"form.readonly\" sf-field-model=\"\" ng-value=\"item.value\" radios-helper=\"\" name=\"{{radiosHelper.getName()}}\"> <span ng-bind-html=\"item.name\"></span></label></div><div class=\"help-block\" sf-message=\"form.description\"></div></div>");
$templateCache.put("decorators/bootstrap/radios.html","<div class=\"form-group schema-form-radios {{::form.htmlClass}}\" ng-class=\"{\'has-error\': form.disableErrorState !== true && hasError(), \'has-success\': form.disableSuccessState !== true && hasSuccess(), \'required\': form.required}\"><label class=\"control-label {{::form.labelHtmlClass}}\" sf-field-model=\"\" schema-validate=\"form\" ng-show=\"showTitle()\">{{::form.title}} <a ng-if=\"form.tooltip\" data-toggle=\"tooltip\" data-placement=\"right\" title=\"{{::form.tooltip}}\"><i class=\"glyphicon glyphicon-info-sign\"></i></a></label><div ng-if=\"!form.columns || form.columns === 1\" class=\"radio\" ng-repeat=\"entry in form.titleMap\"><label><input type=\"radio\" class=\"{{::form.fieldHtmlClass}}\" sf-changed=\"form\" ng-disabled=\"form.readonly\" sf-field-model=\"\" ng-value=\"entry.value\" radios-helper=\"\" name=\"{{radiosHelper.getName()}}\"> <span ng-bind-html=\"entry.name\"></span></label></div><rds-multi-columns size=\"{{::form.titleMap.length}}\" ng-if=\"form.columns > 1\"><div class=\"radio\" ng-repeat=\"entry in form.titleMap.slice($parent.colCtrl.indexFrom, $parent.colCtrl.indexTo)\"><label><input type=\"radio\" class=\"{{::form.fieldHtmlClass}}\" sf-changed=\"form\" ng-disabled=\"form.readonly\" sf-field-model=\"\" ng-value=\"entry.value\" radios-helper=\"\" name=\"{{radiosHelper.getName()}}\"> <span ng-bind-html=\"entry.name\"></span></label></div></rds-multi-columns><div class=\"help-block\" sf-message=\"form.description\"></div></div>");
...
$templateCache.put("decorators/bootstrap/select.html","<div class=\"form-group {{::form.htmlClass}} schema-form-select\" ng-class=\"{\'has-error\': form.disableErrorState !== true && hasError(), \'has-success\': form.disableSuccessState !== true && hasSuccess(), \'has-feedback\': form.feedback !== false, \'required\': form.required}\"><label class=\"control-label {{::form.labelHtmlClass}}\" ng-show=\"showTitle()\">{{::form.title}} <a ng-if=\"form.tooltip\" data-toggle=\"tooltip\" data-placement=\"right\" title=\"{{::form.tooltip}}\"><i class=\"glyphicon glyphicon-info-sign\"></i></a></label><select ng-if=\"!form.readonly\" sf-field-model=\"\" ng-disabled=\"form.readonly\" sf-changed=\"form\" class=\"form-control {{::form.fieldHtmlClass}}\" schema-validate=\"form\" ng-options=\"item.value as item.name group by item.group for item in form.titleMap\" name=\"{{::form.key.slice(-1)[0]}}\"></select><input ng-if=\"form.readonly\" value=\"{{selectedOptionCtrl.selected.name}}\" rds-selected-option=\"\" type=\"text\" placeholder=\"{{::form.placeholder}}\" class=\"form-control {{::form.fieldHtmlClass}}\" id=\"{{::form.key.slice(-1)[0]}}\" ng-disabled=\"form.readonly\"><div class=\"help-block\" sf-message=\"form.description\"></div></div>");
